...
const VerTurnoPacienteModal = ({ turno, onClose }) => {
  ...
  return (
    <div className="modal-overlay" onClick={onClose}>
      <div
        className="modal-container ver-turno-paciente-modal"
        ...
        <div className="modal-body">
                ...
                <div className="form-group">
                  ...
                  <div className="modal-detail">
                    {turno.consulta.formaPago
                      ? turno.consulta.formaPago.charAt(0).toUpperCase() +
                        turno.consulta.formaPago.slice(1)
                      : "No especificado"}
                  </div>
                </div>
          ...
          {turno.notas && (
            <div className="seccion-notas">
              ...
              <div className="modal-detail texto-largo">{turno.notas}</div>
            </div>
          )}
        </div>
